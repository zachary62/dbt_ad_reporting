...
with hourly as (
    ...
    select *
    from "postgres"."public_stg_tiktok_ads"."stg_tiktok_ads__ad_group_report_hourly"
), 
...
advertiser as (
    ...
    select *
    from "postgres"."public_stg_tiktok_ads"."stg_tiktok_ads__advertiser"
), 

campaigns as (

    select *
    from "postgres"."public_stg_tiktok_ads"."stg_tiktok_ads__campaign_history"
    where is_most_recent_record
), 
