...
with report as (
    ...
    select *
    from "postgres"."public_microsoft_ads_source"."stg_microsoft_ads__keyword_daily_report"
...
keywords as (
    ...
    select *
    from "postgres"."public_microsoft_ads_source"."stg_microsoft_ads__keyword_history"
...
ad_groups as (
    ...
    select *
    from "postgres"."public_microsoft_ads_source"."stg_microsoft_ads__ad_group_history"
    where is_most_recent_record = True
...
accounts as (
    ...
    select *
    from "postgres"."public_microsoft_ads_source"."stg_microsoft_ads__account_history"
    where is_most_recent_record = True
