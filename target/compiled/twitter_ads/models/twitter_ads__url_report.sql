...
with report as (
    ...
    select *
    from "postgres"."public_twitter_ads_source"."stg_twitter_ads__promoted_tweet_report"
),

campaigns as (

    select *
    from "postgres"."public_twitter_ads_source"."stg_twitter_ads__campaign_history"
...
accounts as (
    ...
    select *
    from "postgres"."public_twitter_ads_source"."stg_twitter_ads__account_history"
    where is_latest_version
),
...
line_items as (
    ...
    select *
    from "postgres"."public_twitter_ads_source"."stg_twitter_ads__line_item_history"
    where is_latest_version
),
...
promoted_tweets as (
    ...
    select *
    from "postgres"."public_twitter_ads_source"."stg_twitter_ads__promoted_tweet_history"
    where is_latest_version
),
...
tweets as (
    ...
    select *
    from "postgres"."public_twitter_ads_source"."stg_twitter_ads__tweet"
),

tweet_url as (

    select *
    from "postgres"."public_twitter_ads_source"."stg_twitter_ads__tweet_url"
    where index = 0
),
