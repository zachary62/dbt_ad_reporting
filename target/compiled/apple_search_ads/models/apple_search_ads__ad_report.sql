...
with report as (
    ...
    select *
    from "postgres"."public_apple_search_ads_source"."stg_apple_search_ads__ad_report"
), 

ad as (

    select * 
    from "postgres"."public_apple_search_ads_source"."stg_apple_search_ads__ad_history"
