...
with report as (
    select *
    from "postgres"."public_amazon_ads_source"."stg_amazon_ads__advertised_product_report"
), 
...
ads as (
    select *
    from "postgres"."public_amazon_ads_source"."stg_amazon_ads__product_ad_history"
    where is_most_recent_record = True
),
