...
from "postgres"."public_google_ads"."google_ads__ad_report"
...
from "postgres"."public_microsoft_ads"."microsoft_ads__ad_report"
...
from "postgres"."public_facebook_ads"."facebook_ads__ad_report"
...
from "postgres"."public_linkedin_ads"."linkedin_ads__creative_report"
...
from "postgres"."public_pinterest"."pinterest_ads__pin_promotion_report"
...
from "postgres"."public_snapchat_ads"."snapchat_ads__ad_report"
...
from "postgres"."public_tiktok_ads"."tiktok_ads__ad_report"
...
from "postgres"."public_twitter_ads"."twitter_ads__promoted_tweet_report"
...
from "postgres"."public_amazon_ads"."amazon_ads__ad_report"
...
from "postgres"."public_reddit_ads"."reddit_ads__ad_report"
