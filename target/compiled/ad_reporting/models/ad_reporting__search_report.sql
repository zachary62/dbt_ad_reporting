...
from "postgres"."public_microsoft_ads"."microsoft_ads__search_report"
...
from "postgres"."public_apple_search_ads"."apple_search_ads__search_term_report"
...
from "postgres"."public_amazon_ads"."amazon_ads__search_report"
