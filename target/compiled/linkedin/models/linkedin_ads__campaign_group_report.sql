...
with campaign_group as (
    ...
    select *
    from "postgres"."public_linkedin_ads_source"."stg_linkedin_ads__campaign_group_history"
...
account as (
    ...
    select *
    from "postgres"."public_linkedin_ads_source"."stg_linkedin_ads__account_history"
    where is_latest_version
),
...
report as (
    ...
    select *
    from "postgres"."public_linkedin_ads_source"."stg_linkedin_ads__ad_analytics_by_campaign"
),
