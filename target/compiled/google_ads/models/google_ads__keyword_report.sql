...
with stats as (
    ...
    select *
    from "postgres"."public_google_ads_source"."stg_google_ads__keyword_stats"
), 
...
ad_groups as (
    ...
    select *
    from "postgres"."public_google_ads_source"."stg_google_ads__ad_group_history"
    where is_most_recent_record = True
), 
...
criterions as (
    ...
    select *
    from "postgres"."public_google_ads_source"."stg_google_ads__ad_group_criterion_history"
    where is_most_recent_record = True
), 
