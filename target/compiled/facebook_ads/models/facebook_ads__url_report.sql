...
with report as (
    ...
    select *
    from "postgres"."public_facebook_ads_source"."stg_facebook_ads__basic_ad"
...
creatives as (
    ...
    select *
    from "postgres"."public_facebook_ads"."int_facebook_ads__creative_history"
...
accounts as (
    ...
    select *
    from "postgres"."public_facebook_ads_source"."stg_facebook_ads__account_history"
...
ad_sets as (
    ...
    select *
    from "postgres"."public_facebook_ads_source"."stg_facebook_ads__ad_set_history"
    where is_most_recent_record = true
...
campaigns as (
    ...
    select *
    from "postgres"."public_facebook_ads_source"."stg_facebook_ads__campaign_history"
    where is_most_recent_record = true
