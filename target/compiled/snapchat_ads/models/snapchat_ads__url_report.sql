...
with base as (
    ...
    select *
    from "postgres"."public_snapchat_ads_source"."stg_snapchat_ads__creative_url_tag_history"
    where is_most_recent_record = true
...
from fields
    ...
    select *
    from "postgres"."public_snapchat_ads_source"."stg_snapchat_ads__ad_hourly_report"
    ...
    select *
    from "postgres"."public_snapchat_ads_source"."stg_snapchat_ads__ad_history"
    where is_most_recent_record = true

), ad_squads as (

    select *
    from "postgres"."public_snapchat_ads_source"."stg_snapchat_ads__ad_squad_history"
    where is_most_recent_record = true
